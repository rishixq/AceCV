...
const TemplateForm = () => {
    ...
    return (
        ...
        >
            ...
            />
            <div className="rounded-md border border-indigo-900 bg-indigo-50 p-4 shadow-md w-52">
                <label
                    htmlFor="upload"
                ...
                >
                    <svg
                        ...
                        className="h-10 w-10 fill-white stroke-indigo-600"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        strokeWidth="2"
                    >
            ...
            <button
                disabled={loading}
                className="bg-indigo-700 self-end text-white py-3 px-10 rounded-lg mt-4 hover:scale-105 transition-all ease-in-out"
            >
                {loading ? (
